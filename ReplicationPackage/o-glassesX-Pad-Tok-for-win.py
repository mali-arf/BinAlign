...
def main():
        ...
        if not args.input_model:
                ...
                for f in files_file:
                        ...
                        file_type=f.split("/")[1] # JOINT
                        #file_type=f.split("/")[1].split("_")[0] # compiler
                        #file_type=f.split("/")[1].split("_")[1] # OPTIMIZATION
                ...
                for f in files_file:
                        ...
                        ft= f.split("/")[1] # JOINT
                        #ft = f.split("/")[1].split("_")[0] # COMPILER
                        #ft = f.split("/")[1].split("_")[1] # OPTIMIZATION
                        print("ft:",ft)
                        #exit()
                        ...
                        if args.disasm_x86:
                                ...
                                for (offset, size, instr, hexdump) in l:
                                        ...
                                        if size>16:
                                                ...
                                                ins = instr.replace(" ","")
                                                instr_b += chr_tok+ins+"0"*(16-len(ins)-1)
                                                #print(chr_tok+ins[:15]+"0"*(16-len(ins)-1))
                                                #print(tok+bdata[pos:pos+size]+b'\0'*(16-size-1))
                                                #exit()
                                                #print(b)
                                                #exit()
...
#                                        train.extend(BitArray[ord(x)])
                                ...
                                master_dataset_b.append((block,ftype,f))
                                num_of_dataset[ft]+=1
                       # print("offset_count: ",offset_count)

                #データセットの情報を表示
                #print(master_dataset_b[0])
                #exit()
                ...
                for c in range(0,fsize-block_size+1,l):
                        ...
                        if args.disasm_x86:
                                ...
                                #for (offset, size, instr, hexdump) in m:
                                        b = b''
                                        for c_ in range(16-1):#16バイトで命令を切る
                                                if c_ < len(i[3])/2:
