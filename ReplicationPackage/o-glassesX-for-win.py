...
def main():
        ...
        if not args.input_model:
                print("Does not use the input model.............")
                ...
                for f in files_file:
                        ...
                        #file_type = f.split("/")[1].split("_")[0] # FAMILY
                        file_type = f.split("/")[1].split("_")[1] # OPTIMIZATION LEVEL
                ...
                #データセットのダブリをチェック
                print("value of check_dataset: ",check_dataset)
                if check_dataset:
                        ...
                        if args.disasm_x86:
                                ...
                                for i in m:
                                        ...
                                        for c_ in range(16):#16バイトで命令を切る
                                                if c_ < len(i[3])/2:
                                                        b += str.encode(chr(int(i[3][c_*2:c_*2+2],16)))
                                                else:
                                                        b += b'\0'
                                        block += b
